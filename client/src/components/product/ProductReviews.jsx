...
export default function ProductReviews({ p_rating, reviewList }) {
  ...
  return (
    <div className="relative mx-auto mb-10 w-full max-w-7xl px-5">
      {/* Left Scroll Button */}
      <button
        className="absolute left-5 top-64 flex h-12 w-12 -translate-y-1/2 transform items-center justify-center rounded-full bg-gray-200 text-gray-600 transition duration-300 hover:scale-105 hover:bg-gray-300 hover:text-gray-800 focus:outline-none"
        onClick={scrollLeft}
      >
        <svg
      ...
      <div>
        ...
        <p className="mr-2">{reviewList && reviewList.length} Review{reviewList && reviewList.length > 1 && " "}</p>
      </div>
      {/* Carousel container */}
      <div
        ...
        ref={carouselRef}
      >
        <div className="flex w-[90%] lg:w-[40%] mx-16">
          {reviewList &&
      ...
      {/* Right Scroll Button */}
      <button
        className="absolute right-5 top-64 flex h-12 w-12 -translate-y-1/2 transform items-center justify-center rounded-full bg-gray-200 text-gray-600 transition duration-300 hover:scale-105 hover:bg-gray-300 hover:text-gray-800 focus:outline-none"
        onClick={scrollRight}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
...
const Card = ({ author, order_date, review_msg, stars }) => {
  ...
  return (
    <div className={classNames(stars >= 0 ? "h-96" : "h-40", "mr-4 w-full flex-none px-10 pt-10 border rounded-lg border-slate-400")}>
